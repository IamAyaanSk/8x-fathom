...
import { formatMeetingBaasTranscript } from '@repo/meeting-dispatch'
...
const postMeetingSummaryGenerateController = async (
  ...
  try {
    ...
    try {
      // TODO: Move this to ingestion worker
      ...
      transcript = formatMeetingBaasTranscript(parsedTranscript)
    } catch {
