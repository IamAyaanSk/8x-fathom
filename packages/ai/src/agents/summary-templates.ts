...
function _formatTemplateDefinition(
  definition: SummaryTemplateDefinition
): string {
  const sectionBlocks = definition.sections
    .map(_formatSectionBlock)
    .join('\n\n')
...
const _SUMMARY_TEMPLATE_DEFINITIONS: Record<
  SummaryTemplateId,
...
> = {
    ...
    sections: [
      {
        heading: 'Overview',
        guidance:
          'Two to four sentences on purpose and outcome of the conversation.'
      },
      {
        heading: 'Key takeaways',
        guidance:
          'Bullet list of the most important insights someone should remember.'
      },
      {
  ...
  sales: {
    sections: [
      ...
      },
      {
        ...
        guidance:
          'Timeline, process, evaluation criteria, and competitors if raised.'
      },
      {
  ...
  sales_sandler: {
    sections: [
      {
        heading: 'Overview',
        guidance: 'Short summary of the sales conversation.'
      },
      {
  ...
  sales_spiced: {
    sections: [
      {
        heading: 'Situation',
        guidance: 'Current state and context of the prospect.'
      },
      {
        heading: 'Pain',
        guidance: 'Problems and frustrations they described.'
      },
      {
        heading: 'Impact',
        guidance:
          'Business impact tied to the pain when speakers connected them.'
      },
      {
  ...
  sales_meddpicc: {
    sections: [
      {
        heading: 'Metrics',
        guidance: 'Quantified goals or success measures discussed.'
      },
      {
      ...
      {
        heading: 'Identified pain',
        guidance: 'Core pain driving the initiative.'
      },
      {
        heading: 'Champion',
        guidance: 'Internal advocate and their role if stated.'
      },
  ...
  sales_bant: {
    sections: [
      {
        heading: 'Budget',
        guidance: 'Budget range, constraints, or funding status.'
      },
      {
        heading: 'Authority',
  ...
  customer_success: {
    sections: [
      {
        heading: 'Overview',
        guidance: 'Purpose of the customer conversation.'
      },
      {
  ...
  candidate_interview: {
    sections: [
      {
        heading: 'Overview',
        guidance: 'Role focus and interview format in one short paragraph.'
      },
      {
  ...
  demo: {
    sections: [
      {
        heading: 'Overview',
        guidance: 'Who attended and what was demoed at a high level.'
      },
      {
  ...
  project_kick_off: {
    sections: [
      ...
      {
        heading: 'Open items',
        guidance: 'Unresolved topics needing follow-up.'
      }
    ]
  },
  project_update: {
  ...
  q_and_a: {
    sections: [
      {
        heading: 'Overview',
        guidance: 'Topic or context for the Q&A session.'
      },
      {
...
export const summaryTemplateSectionHeadings =
  _buildSummaryTemplateSectionHeadings()

export function getSummaryTemplateSystemPrompt(
